 ...
 * @author aferr
 */
public class SubtractionStackVariableOperationTest {
    
    private CalculatorStack calculatorStack;
    private ComplexVariablesVector variablesVector;
    private char variable;
    private SubtractionStackVariableOperation subtractionSVO;
    ...
    public void init(){
        ...
        variable = 'a';
        subtractionSVO = new SubtractionStackVariableOperation(calculatorStack, variablesVector, variable);
    }
    ...
    public void testExecuteEmptyStack() { 
        ...
        Complex variableNumber = new Complex(42, 42);
        variablesVector.setVarValue(variable, variableNumber);
        subtractionSVO.execute();
    ...
    public void testExecuteFirstQuadrant(){ 
        ...
        Complex expectedNumber = new Complex(-1.0, -1.0);
        Complex topNumber = calculatorStack.top();
    ...
    */
    ...
    public void testExecuteSecondThirdQuadrant(){ 
        ...
        Complex expectedNumber = new Complex(1.0, 4.0);
        Complex topNumber = calculatorStack.top();
        assertEquals(expectedNumber, topNumber);
    }
